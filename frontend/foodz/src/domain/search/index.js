...
import {
    ...
    getRestaurantsError,
    getQuery,
} from "../../reducer/Restaurants/restaurantsReducer";
import {
    getFoods,
    getFoodsPending,
    getFoodsError,
} from "../../reducer/Foods/foodsReducer";
...
import {
    ...
    getFiltersFromUrl,
    resetFilters,
} from "../../utilities/filterAndOrder/index";
class Search extends React.Component {
    ...
    handleSearch = (event) => {
        if (event.keyCode == 13) {
            ...
            parsed.query = document.getElementById(
                "input-search-white-nav"
            ).value;
    ...
    render() {
        ...
        return (
            <>
                <header>
                    <WNavBar
                        handle_search={this.handleSearch}
                        city="Tiaret"
