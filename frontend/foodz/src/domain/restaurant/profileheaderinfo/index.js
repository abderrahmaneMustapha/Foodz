...
let profile_src =
  "https://scontent-mrs2-1.xx.fbcdn.net/v/t1.0-9/16196015_10154888128487744_6901111466535510271_n.png?_nc_cat=103&_nc_sid=85a577&_nc_ohc=hwwp88BW_cYAX-zZpa_&_nc_ht=scontent-mrs2-1.xx&oh=3ded93f2ca4a9ce8a3ea2ceaebd0be58&oe=5F5F9917";
        ...
        <div className="mx-md-2">
          <div className="d-flex flex-row align-items-center">
            ...
            {this.props.is_verified === true ? (
              <svg
                ...
                height="1.5em"
                viewBox="0 0 16 16"
                class="bi bi-check-circle-fill ml-1"
                fill="#3859DE"
          ...
          <div className=" d-flex flex-wrap justify-content-between align-items-center">
            ...
            <div className="">
              {this.props.open_now ? (
                <>
                  ...
                  <span className="font-weight-bold ml-md-2 ml-sm-0">
                    open now
                  </span>
                </>
              ) : (
            ...
            <div id="profile-contact" className="d-flex flex-wrap ">
              ...
              <span className="ml-md-5  font-weight-bold">phone number : </span>{" "}
              <a href="#">{this.props.phone}</a>
            </div>
          </div>
        </div>
      </div>
