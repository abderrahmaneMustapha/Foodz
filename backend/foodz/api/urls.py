...
router.register(r'comments', views.CommentsViewsSet)
router.register(r'locations', views.LocationViewSet)
router.register(r'restaurant', views.RestaurantViewSet)
router.register(r'restaurant-comment', views.RestaurantCommentsViewsSet)
router.register(r'restaurant-comment-vote-up', views.ReastaurantCommentsUpViewsSet)
router.register(r'restaurant-comment-vote-down', views.ReastaurantCommentsDownViewsSet)
...
urlpatterns = [
    ...
    path('api/create-account', views.UserCreateViewSet.as_view(), name="create-account" )
]